...
public class VisaConfirmationSteps {
    ...
    public void iSelectReasonTourismTourism() {
        new ReasonForTravelPage().reasonForTravelling("Tourism");
    }

    @And("^I select reason wavb 'Work, academic visit or business'$")
    public void iSelectReasonWavbWorkAcademicVisitOrBusiness() {
        new ReasonForTravelPage().reasonForTravelling("Work,academic visit or business");
    }
    ...
    public void iSelectReasonJpfJoinPartnerOrFamilyForALongStay() {
        new ReasonForTravelPage().reasonForTravelling("Join partner or family for a long stay");
    }
